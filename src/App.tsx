      ...
      >
        <div className="flex justify-center items-center md:items-start flex-col gap-1 md:gap-3 p-3">
          {/* <BlurText
            ...
            animateBy="letters"
            direction="top"
            className="text-4xl md:text-6xl text-cyan-500 font-extrabold s:text-3xl"
          /> */}
          <p className="text-4xl md:text-6xl font-extrabold text-transparent bg-gradient-to-r from-cyan-500 to-teal-500 bg-clip-text inline-block">
            Jerico Lopez
          </p>
          <TextType
      ...
      <div id="about" className="w-full backdrop-blur-2xl">
        ...
        <div className="py-10">
          <div className="flex justify-center">
            <p className="mb-5 text-5xl font-extrabold text-transparent md:self-start bg-gradient-to-r from-cyan-500 to-teal-500 inline-block bg-clip-text">
              About Me
            </p>
          </div>
          <div className="flex flex-wrap justify-evenly items-center gap-3">
            ...
            <div>
              <p className="text-gray-300 text-lg max-w-3xl text-center md:text-left px-4">
                ...
                , with a strong passion for web development and programming. I
                currently live in Capiz, Philippines. <br /> <br /> I've always
                been fascinated by how technology works, and ever since I
                started learning to code, I knew I wanted to become a
                programmer. Solving bugs, building real-world applications, and
                exploring new technologies keep me motivated. One of my recent
                projects was a Library Management System that integrates RFID
                for automated patron logging, which deepened my interest in
                developing practical and efficient systems. <br /> <br /> While
                I'm highly dedicated to coding, I also make time for rest. As
                one programmer said, “Don’t forget to touch some grass,” so I
                make sure to step away and recharge. I enjoy gaming, swimming,
                and going on long rides during my free time. <br /> <br /> I'm
                open to relocation or working in any assigned location. I am
                excited to contribute to a team where I can continue growing as
                a developer and make a meaningful impact.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-around p-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <p className="text-gray-300 text-lg">February 2025 - June 2025</p>
              <p className="text-gray-300 text-lg">
                Pueblo De Panay Roxas City
              </p>
            </div>
            <p className="text-gray-400 max-w-3xl text-lg">
              This experience was more technical and hands-on, involving various
              python programming tasks and system design activities. We
              developed console-based applications such as POS systems, ATM
              simulators, and a clinic appointment reservation system. We also
              created various system diagrams, including Data Flow Diagrams,
              Activity Diagrams, Use Case Diagrams, and Flowcharts for several
              applications like the Barangay Document Request Portal. One of our
              final outputs was a grade calculator web application built using
              Flask. In DBTC, I learned various programming concepts and
              practices such as variables, data types, control structures,
              functions, object-oriented programming (OOP), the SOLID
              principles, database handling, and error handling. We also tackled
              workplace soft skills like handling customer complaints, resolving
              conflicts, identifying unconscious biases, and understanding
              diversity, equality, and occupational safety. We were exposed to
              various tools and technologies, including Python, Flask, SQL, and
              VS Code.
            </p>
          </div>
        </div>
